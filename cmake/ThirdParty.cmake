...
# Recursively set MSVC_RUNTIME_LIBRARY=/MD on every target created under `dir`.
function(_translator_force_msvc_dll_runtime dir)
    ...
    foreach(_t IN LISTS _targets)
        ...
        if(NOT _type STREQUAL "INTERFACE_LIBRARY" AND NOT _type STREQUAL "UTILITY")
            set_target_properties(${_t} PROPERTIES MSVC_RUNTIME_LIBRARY "MultiThreaded$<$<CONFIG:Debug>:Debug>DLL")
        endif()
    endforeach()
    get_property(_subdirs DIRECTORY ${dir} PROPERTY SUBDIRECTORIES)
    foreach(_s IN LISTS _subdirs)
        _translator_force_msvc_dll_runtime(${_s})
    endforeach()
endfunction()
