...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/Kevin-KIM98/offline-translator/releases/download/v0.3.12/OfflineTranslatorCore.xcframework.zip",
            checksum: "2737c645ab6e459fd19f09258efb32f757908a8e145bd377f1ad2be2ff095753"
        ),
