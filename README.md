...
management. Grab
[offline-interpreter-1.0.0.apk](https://github.com/Kevin-KIM98/offline-translator/releases/download/v0.3.8/offline-interpreter-1.0.0.apk)
...
```kotlin
implementation(files("libs/offline-translator-0.3.8.aar"))
